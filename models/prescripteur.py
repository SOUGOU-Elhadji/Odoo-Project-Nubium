...
class CreatePrescripteur(models.Model):
    _name = 'create.prescripteur'
    _rec_name = 'name'
    _description = 'Create prescripteur'
    ...
    code = fields.Char('Code APE/NAF')
    numero_tva = fields.Char('Numéro de TVA intra-commun')
